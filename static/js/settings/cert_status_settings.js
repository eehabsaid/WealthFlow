...
async function renderCertStatusSettings() {
  ...
  const certStatusHint = t(
    "cert_status_hint",
    "These statuses appear in the Certificate form and on the Bank Certificates page. Terminal statuses indicate the certificate lifecycle has ended."
  );
