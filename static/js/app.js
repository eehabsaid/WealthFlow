...
function renderSidebar() {
    ...
    sidebar.innerHTML = `
        <div class="sidebar-brand">
            ...
            <div class="brand-text">Salary &amp; Balance Tracker</div>
        </div>
        <nav class="sidebar-nav">
            ...
            <div class="nav-section-content">
                ${companyItems}
                <button class="nav-item" onclick="navigate('all-companies')"><i class="bi bi-building"></i>All Companies</button>
            </div>

            <div style="border-top:1px solid var(--border-color); margin:10px 0;"></div>
            <button class="nav-item" onclick="navigate('balance')"><i class="bi bi-wallet2"></i>Balance</button>
            <button class="nav-item" onclick="navigate('bank-certificates')"><i class="bi bi-file-earmark-text"></i>Bank Certificates</button>
            <button class="nav-item" onclick="navigate('exchange-rates')"><i class="bi bi-currency-exchange"></i>Exchange Rates</button>
            <button class="nav-item" onclick="navigate('gold-price')"><i class="bi bi-brilliance"></i>Gold Price</button>
            <div style="border-top:1px solid var(--border-color); margin:10px 0;"></div>
            ...
            <div class="nav-section-content">
                <button class="nav-item" onclick="navigate('expenses')"><i class="bi bi-receipt"></i>Expenses</button>
                <button class="nav-item" onclick="navigate('expense-categories')"><i class="bi bi-tag"></i>Categories</button>
                <button class="nav-item" onclick="navigate('reports')"><i class="bi bi-graph-up"></i>Reports</button>
            </div>

            <div style="border-top:1px solid var(--border-color); margin:10px 0;"></div>
            <button class="nav-item" onclick="navigate('settings-languages')"><i class="bi bi-gear"></i>Settings</button>
        </nav>`;
...
function route() {
    ...
    if (hash === 'dashboard') {
        ...
        if (typeof setBreadcrumb === 'function') setBreadcrumb(t('nav_exchange_rates', 'Exchange Rates'), '');
        if (typeof bc !== 'undefined' && bc) bc.textContent = t('nav_exchange_rates', 'Exchange Rates');
        renderExchangeRates();

    } else if (hash === 'gold-price') {
        if (typeof setBreadcrumb === 'function') setBreadcrumb(t('nav_gold_price', 'Gold Price'), '');
        if (typeof bc !== 'undefined' && bc) bc.textContent = t('nav_gold_price', 'Gold Price');
        renderGoldPrice();
...
async function previewAndUploadAvatar(input) {
    ...
    reader.onload = e => {
        ...
        if (prev) prev.outerHTML =
            `<img id="avatarPreview" src="${e.target.result}"
                 style="width:90px;height:90px;border-radius:50%;
                        object-fit:cover;border:3px solid var(--border-color)">`;
    };
