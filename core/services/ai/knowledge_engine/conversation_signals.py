"""
Conversation-signal extraction mixin for AIKnowledgeEngine.

Split out of the former monolithic knowledge_engine.py (200-line rule).
extract_knowledge_from_conversation is a classmethod that calls
cls.record_knowledge_entry(...) — available on the composed
AIKnowledgeEngine class via this mixin, regardless of which file each
method physically lives in.
"""
...
class ConversationSignalsMixin:
    @classmethod
