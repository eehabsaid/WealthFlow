"""Static seed data for the seed_data management command.

Pure code motion from the original seed_data.py management command — same
values, only relocated so that seed_data.py can stay a flat,
Django-discoverable command module under 200 lines.
"""
